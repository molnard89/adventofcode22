def list_contains(list1, list2):
    return 1 if all(x in list1 for x in list2) else 0
...
with open("cleaning_schedule.txt") as f:
    for line in f.readlines():
        ...
        contains1 = list_contains(elf1_schedule, elf2_schedule)
        contains2 = list_contains(elf2_schedule, elf1_schedule)
        overlapping_schedules += max(contains1, contains2)

print(f"Number of overlapping schedules = {overlapping_schedules}")